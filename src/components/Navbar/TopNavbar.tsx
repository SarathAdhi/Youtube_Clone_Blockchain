...
const TopNavbar = () => {
  ...
  return (
    <header className="z-50 px-6 w-full h-14 bg-[#202020] sticky top-0 flex items-center justify-between">
      <Button className="block md:hidden" onClick={() => setIsOpen(true)}>
        <HamBurgerMenu className="w-6 h-6 text-white" />
      </Button>

      <div className="w-[500px] mx-auto flex items-center bg-[#313131]">
        <input
