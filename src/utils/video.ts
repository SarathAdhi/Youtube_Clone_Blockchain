...
export const isChannelNameExist = async (channelName: string) => {
  const VideoContract = getContractDetails();
...
export const getVideoByUuid = async (uuid: string) => {
  const VideoContract = getContractDetails();
...
export const addViews = async (id: any) => {
  const VideoContract = getContractDetails();
...
export const addLikes = async (id: any) => {
  const VideoContract = getContractDetails();
...
export const addDisLikes = async (id: any) => {
  const VideoContract = getContractDetails();
...
// export const voteVideo = async (id: string, optionId: number) => {
//   const VideoContract = getContractDetails();

//   return await VideoContract?.vote(id, optionId)
//     .then((data: any) => data)
//     .catch((error: any) => showErrorToast(error.message));
// };
