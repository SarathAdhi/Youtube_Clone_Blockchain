...
export const HamBurgerMenu: React.FC<Props> = ({ className, ...props }) => {
  return (
    <svg
...
export const HomeSvg: React.FC<Props> = ({ className, ...props }) => {
  return (
    <svg
      viewBox="0 0 24 24"
...
export const ExploreSvg: React.FC<Props> = ({ className, ...props }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      preserveAspectRatio="xMidYMid meet"
...
export const UploadSvg: React.FC<Props> = ({ className, ...props }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      preserveAspectRatio="xMidYMid meet"
